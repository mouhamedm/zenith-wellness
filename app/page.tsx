  ...
  return (
    <div className="relative w-full bg-background">
      ...
      <FlowArt aria-label="Notre histoire et approche du bien-etre">
        ...
        <FlowSection aria-label="Qui nous sommes" style={{ backgroundColor: "#2d6a4f", color: "#fff" }}>
        ...
        <FlowSection aria-label="Notre approche holistique" style={{ backgroundColor: "#1b2a41", color: "#fff" }}>
          ...
          <div className="flex flex-wrap gap-[3vw]">
            <div className="min-w-[180px] flex-1">
              <p className="mb-2 text-sm font-bold uppercase tracking-wider">Massages</p>
              <p className="text-[clamp(0.85rem,1.3vw,1.05rem)] leading-relaxed opacity-60">Suedois, aux pierres chaudes, drainage lymphatique. Chaque technique choisie pour votre besoin precis.</p>
            </div>
            <div className="min-w-[180px] flex-1">
              <p className="mb-2 text-sm font-bold uppercase tracking-wider">Yoga & Meditation</p>
              <p className="text-[clamp(0.85rem,1.3vw,1.05rem)] leading-relaxed opacity-60">Cours pour tous niveaux, sessions privees et retraites immersives guidees par nos instructeurs certifies.</p>
            </div>
            <div className="min-w-[180px] flex-1">
              <p className="mb-2 text-sm font-bold uppercase tracking-wider">Soins Spa</p>
              <p className="text-[clamp(0.85rem,1.3vw,1.05rem)] leading-relaxed opacity-60">Soins du visage, enveloppements, bains aromatherapeutiques. Une parenthese sensorielle complete.</p>
            </div>
          </div>
          <hr className="my-[2vw] border-t border-white/30" />
          <div className="flex flex-wrap gap-[3vw]">
            ...
            <div className="min-w-[180px] flex-1">
              ...
              <p className="text-[clamp(0.85rem,1.3vw,1.05rem)] leading-relaxed opacity-60">Piscine therapeutique, bains bouillonnants et hydromassage pour denouer les tensions profondes.</p>
            </div>
            <div className="min-w-[180px] flex-1">
              <p className="mb-2 text-sm font-bold uppercase tracking-wider">Sophrologie</p>
              <p className="text-[clamp(0.85rem,1.3vw,1.05rem)] leading-relaxed opacity-60">Techniques de relaxation dynamique pour gerer le stress, ameliorer le sommeil et retrouver la serenite.</p>
            </div>
          </div>
        </FlowSection>
        ...
        <FlowSection aria-label="Votre parcours de soin" style={{ backgroundColor: "#f5f0e8", color: "#1a1a1a" }}>
          ...
          <div className="flex flex-wrap gap-[3vw]">
            <div className="min-w-[180px] flex-1">
              <p className="mb-2 text-sm font-bold uppercase tracking-wider">01 — Accueil</p>
              <p className="text-[clamp(0.85rem,1.3vw,1.05rem)] leading-relaxed opacity-60">Consultation diagnostique gratuite. Nos praticiens ecoutent, comprennent, personnalisent.</p>
            </div>
            <div className="min-w-[180px] flex-1">
              <p className="mb-2 text-sm font-bold uppercase tracking-wider">02 — Rituel</p>
              <p className="text-[clamp(0.85rem,1.3vw,1.05rem)] leading-relaxed opacity-60">Bain de vapeur, gommage corporel et moment de silence pour preparer votre corps au soin.</p>
            </div>
            <div className="min-w-[180px] flex-1">
              <p className="mb-2 text-sm font-bold uppercase tracking-wider">03 — Soin</p>
              <p className="text-[clamp(0.85rem,1.3vw,1.05rem)] leading-relaxed opacity-60">Votre soin principal, realise par nos experts dans des cabines intimistes et apaisantes.</p>
            </div>
          </div>
          <hr className="my-[2vw] border-t border-black/20" />
          <div className="flex flex-wrap gap-[3vw]">
            <div className="min-w-[180px] flex-1">
              <p className="mb-2 text-sm font-bold uppercase tracking-wider">04 — Recuperation</p>
              <p className="text-[clamp(0.85rem,1.3vw,1.05rem)] leading-relaxed opacity-60">Salon de relaxation, tisanes et temps libre dans notre espace zen pour prolonger les bienfaits.</p>
            </div>
            <div className="min-w-[180px] flex-1">
            ...
            <div className="min-w-[180px] flex-1">
              ...
              <p className="text-[clamp(0.85rem,1.3vw,1.05rem)] leading-relaxed opacity-60">Programme sur mesure et rappels doux pour que le bien-etre devienne une pratique reguliere.</p>
            </div>
          </div>
        </FlowSection>
        ...
        <FlowSection aria-label="Nos engagements" style={{ backgroundColor: "#5c3d2e", color: "#fff" }}>
          ...
          <div className="flex flex-wrap gap-[3vw]">
            <div className="min-w-[180px] flex-1">
              <p className="mb-2 text-sm font-bold uppercase tracking-wider">5 000+ clients</p>
              <p className="text-[clamp(0.85rem,1.3vw,1.05rem)] leading-relaxed opacity-60">Qui nous font confiance chaque annee pour leur equilibre et leur vitalite.</p>
            </div>
            <div className="min-w-[180px] flex-1">
              <p className="mb-2 text-sm font-bold uppercase tracking-wider">98% satisfaits</p>
              <p className="text-[clamp(0.85rem,1.3vw,1.05rem)] leading-relaxed opacity-60">Taux de satisfaction recueilli apres chaque soin. Notre priorite absolue.</p>
            </div>
            <div className="min-w-[180px] flex-1">
          ...
          <div className="flex flex-wrap gap-[3vw]">
            <div className="min-w-[180px] flex-1">
              <p className="mb-2 text-sm font-bold uppercase tracking-wider">Eco-responsable</p>
              <p className="text-[clamp(0.85rem,1.3vw,1.05rem)] leading-relaxed opacity-60">Centre a energie solaire, zero plastique a usage unique, partenaires locaux et equitables.</p>
            </div>
            <div className="min-w-[180px] flex-1">
              <p className="mb-2 text-sm font-bold uppercase tracking-wider">Inclusif</p>
              <p className="text-[clamp(0.85rem,1.3vw,1.05rem)] leading-relaxed opacity-60">Accueil de toutes les morphologies, ages et conditions. Un espace ou chacun se sent bienvenu.</p>
            </div>
            <div className="min-w-[180px] flex-1">
              <p className="mb-2 text-sm font-bold uppercase tracking-wider">Certifie</p>
              <p className="text-[clamp(0.85rem,1.3vw,1.05rem)] leading-relaxed opacity-60">Agrement national, membres de la Federation Francaise du Spa et du Bien-etre.</p>
            </div>
          </div>
        </FlowSection>
